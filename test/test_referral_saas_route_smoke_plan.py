...
def test_referral_saas_route_smoke_plan_defaults_to_read_only():
    ...
    assert plan["omittedSeededWriteRoutes"] == [
        ...
        "referral_saas_account_campaign_programme_binding",
        ...
        "referral_saas_account_campaign_activation_request",
        "referral_saas_account_campaign_lifecycle_command",
        ...
        "referral_saas_integration_configuration_save",
        "referral_saas_api_access_verification",
        "referral_saas_webhook_test_dispatch",
        "referral_saas_message_provider_test",
        "referral_saas_credential_execution_check",
        "referral_saas_account_report_export_request",
        "referral_saas_account_report_delivery_schedule_create",
        "referral_saas_account_report_delivery_schedule_update",
    ...
    assert {route["path"] for route in plan["routes"]} == {
        ...
        "/v1/referral-saas/accounts/{account_ref}/integrations/configuration",
        "/v1/referral-saas/accounts/{account_ref}/integrations/execution-readiness",
        "/v1/referral-saas/accounts/{account_ref}/integrations/provider-vault/readiness",
        "/v1/referral-saas/accounts/{account_ref}/integrations/configuration/validate",
        "/v1/referral-saas/accounts/{account_ref}/referrals",
        "/v1/referral-saas/accounts/{account_ref}/referrals/{referral_track_id}",
        "/v1/referral-saas/accounts/{account_ref}/referrer-identities",
        ...
        "/v1/referral-saas/accounts/{account_ref}/campaigns/{campaign_code}/lifecycle",
        "/v1/referral-saas/accounts/{account_ref}/reports/{report_type}",
        "/v1/referral-saas/accounts/{account_ref}/reports/{report_type}/delivery-schedules",
        "/v1/referral-saas/accounts/{account_ref}/delivery-schedules/{schedule_id}",
        "/v1/referral-saas/accounts/{account_ref}/delivery-schedules/{schedule_id}/readiness",
        "/v1/referral-saas/accounts/{account_ref}/reports/{report_type}/exports/preview",
        "/v1/referral-saas/accounts/{account_ref}/reports/{report_type}/exports/validate",
