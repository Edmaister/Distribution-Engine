...
class FakeConnection:
    def __init__(self, *, duplicate_ref=None):
...
async def test_create_durable_account_from_ready_draft(monkeypatch):
    ...
    account_query, account_params = conn.fetchrow_calls[1]
    ...
    audit_query, audit_params = conn.fetchrow_calls[6]
