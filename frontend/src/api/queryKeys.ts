export const queryKeys = {
  ...
  referralSaasOperationsOverview: (limit: number, refreshKey = 0) =>
  ...
  referralSaasAccountReferralAttribution: (
    accountRef: string,
    refType: string,
    externalRef: string,
    context: string,
  ...
  referralSaasAccountJourneyVersions: (
    accountRef: string,
    refType: string,
    externalRef: string,
    context: string,
