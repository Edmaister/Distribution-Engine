...
Remaining campaign/frontend gaps are object-store/signed URL hardening,
scheduled delivery, repair/replay guardrails, and progress/attribution mutation
proof beyond campaign report/export preview.
...
10. Harden TASK-328/TASK-330 export runtime with object-store/signed URL, scheduled delivery, and non-local proof.
