...
support-case lifecycle UI wiring and aggregate queues, and progress/attribution
...
credential/auth, billing, money, or DLaaS side effects. Support-case
notes/status UI wiring and aggregate support queues remain separate future
gaps.
