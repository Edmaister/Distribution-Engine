...
Current rating now reflects TASK-380 support/recovery workspace evidence: Referral
Management remains 9.99/10 and Campaign Attribution moves to 9.999992/10. The
...
now have signed-download metadata, expiry, schedule intent, and deletion proof.
