...
| Attribution | TASK-376 now adds the dedicated Campaign Attribution projection/page with customer-scoped campaign/source/channel confidence, gaps, conflict, and explainability controls. Referral/Referrer Attribution remains the separate who-got-credit projection. | TASK-377 |
