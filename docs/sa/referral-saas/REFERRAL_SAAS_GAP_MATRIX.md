...
| Frontend SaaS workflow | Role-specific React pages and tests exist; TASK-170 account setup readiness, TASK-169/TASK-171 reports/export preview, TASK-172 campaign readiness, TASK-173 link/code workflow, TASK-174 product link/code API seam, TASK-177 validation recovery/retry UI, TASK-179 operator inspect UI, TASK-180 attribution trace API, TASK-181 attribution trace UI, TASK-182 progress/status API, TASK-183 progress/status UI, TASK-184 support hub, TASK-185 focused workspace shell, TASK-190 account setup/maintenance architecture, TASK-191 account setup wrapper contract, TASK-192 account setup workflow shell, TASK-193 setup draft action wiring, TASK-201 durable account resolver wiring, TASK-202 physical draft-save verification, TASK-203 durable account creation service, TASK-204 guarded account creation API wrapper, TASK-205 workflow UX clarification, TASK-206 physical create-account proof, and TASK-207 Account Setup create-action wiring now provide ringfenced Referral SaaS admin/API surfaces and workflow direction. | Coherent Referral SaaS workflow: account setup, integrated readiness, account maintenance, campaign setup, referral link/code management, event/attribution investigation, reporting, safe status. | Focused surfaces now cover a clearer Account Setup parent workflow and Step 1 company profile child workflow with guarded draft validation/save/submit/review action wiring, durable account resolution, physical draft-save proof, durable account creation service and API wrapper, physical create-account proof, guarded account creation UI action, readiness, campaign readiness, reports, exports preview, product-backed link/code execution, validation recovery posture, operator inspection, attribution trace, progress/status, support triage, and ringfenced product navigation; full reviewed-draft journey hardening, UI-driven local account setup proof, membership-aware account setup, account-safe status, customer-facing surfaces, live E2E proof, and deeper campaign workflows remain open. | P1 | TASK-207 complete; next tasks should physically test the full Account Setup UI path and harden the review/evidence path before moving to campaign work | Frontend route tests; accessibility tests; no-internal-leak tests; setup workflow smoke tests; account create-action tests; duplicate/already-created state tests; maintenance read-model tests; local physical setup proof. |
