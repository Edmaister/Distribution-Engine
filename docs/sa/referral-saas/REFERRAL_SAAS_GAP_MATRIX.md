...
scheduled delivery, retention enforcement, repair/replay guardrails, and
...
10. Harden TASK-328/TASK-329 export runtime with object-store/signed URL, retention, scheduled delivery, and non-local proof.
