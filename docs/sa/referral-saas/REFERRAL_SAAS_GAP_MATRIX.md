...
campaign, invite, link/code, export, billing, or money side effects.

Remaining campaign/frontend gaps are execution of the TASK-269 proof against
local/staging data, persisted export storage/audit/downloads, and support-case
persistence.
