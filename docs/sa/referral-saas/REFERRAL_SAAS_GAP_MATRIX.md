...
without firing live provider actions. Runtime credential lifecycle, webhook
dispatch, invite delivery, auth/login changes, campaign activation, billing,
and money movement remain separate future gaps.
