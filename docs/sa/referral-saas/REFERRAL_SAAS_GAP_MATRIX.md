...
| Campaign management | TASK-369 now enforces partner-safe campaign read, create, policy-write, review-submit, review-decision, and activation capabilities server-side for selected-customer campaign wrappers. Remaining gaps are separation of duties, pre-activation decision proof, and lifecycle controls. | TASK-369 to TASK-371 |
