...
| Referral operations | TASK-372 now adds account-scoped referral registry/detail with safe status, progress anchors, attribution evidence, missing-evidence signals, and redactions. TASK-373 now adds safe referrer identity directory and dimensions. TASK-374 now hardens progress timeline/source/idempotency evidence and recovery posture. Remaining gap is governed correction/replay/reassignment. | TASK-375 |
