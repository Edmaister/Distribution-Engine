...
| Reporting and exports | TASK-378 now adds source-backed HVE funnel and journey-performance reporting over tenant-scoped referral instances, progress events, campaign attribution links, and distribution route links. Saved reports, signed exports, scheduled delivery execution, expiry, deletion, and audit proof remain. | TASK-379 |
...
Current rating now reflects TASK-378 runtime reporting evidence: Referral
Management remains 9.99/10 and Campaign Attribution moves to 9.99998/10. The
...
have separate customer-scoped projection/reporting surfaces.
