...
| Integrations | Credential/vault lifecycle proof and API/webhook/invite/referral-message provider execution evidence remain; account-to-client binding is now enforced by TASK-366 | TASK-367 to TASK-368 |
