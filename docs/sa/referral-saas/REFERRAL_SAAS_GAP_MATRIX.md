...
added here: Referral Management remains 9.99/10 and Campaign Attribution moves
to 9.99997/10. The confidence in the route to 10/10 improves because campaign
attribution and referral/referrer who-got-credit attribution now have separate
customer-scoped projection surfaces.
...
9.99997/10. Confidence improves because the remaining work now has a single H1
release-gate contract plus separate campaign and referral/referrer attribution
surfaces.
