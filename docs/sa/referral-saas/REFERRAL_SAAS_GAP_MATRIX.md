...
| Referral operations | TASK-372 now adds account-scoped referral registry/detail with safe status, progress anchors, attribution evidence, missing-evidence signals, and redactions. TASK-373 now adds safe referrer identity directory and dimensions. Remaining gaps are complete progress timeline/idempotency evidence and governed correction/replay/reassignment. | TASK-374 to TASK-375 |
