...
| Referral operations | TASK-372 now adds account-scoped referral registry/detail with safe status, progress anchors, attribution evidence, missing-evidence signals, and redactions. Remaining gaps are safe referrer identity dimensions, complete progress timeline/idempotency evidence, and governed correction/replay/reassignment. | TASK-373 to TASK-375 |
