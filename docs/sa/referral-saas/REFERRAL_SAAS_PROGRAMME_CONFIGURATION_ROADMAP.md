...
| TASK-410 | Complete - campaign activation now requires published programme binding, derives journey context from the programme version, and keeps legacy journey-binding as compatibility only. |
