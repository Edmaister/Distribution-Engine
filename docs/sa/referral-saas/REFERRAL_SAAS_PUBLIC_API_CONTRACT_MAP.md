...
| `/v1/referral-saas/operator/support-cases` | `GET` | TASK-145 future contract; TASK-295/TASK-297/TASK-322 selected-customer persistence boundary; TASK-321 selected-customer UI | Operator/support role | Future operator aggregate only. Selected-customer list/create/read and backend notes/status lifecycle APIs now exist from account routes; aggregate queue and notes/status UI wiring remain separate. |
