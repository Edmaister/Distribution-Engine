...
| `/v1/referral-saas/operator/support-cases` | `GET` | TASK-145 future contract; TASK-295/TASK-297 selected-customer persistence boundary; TASK-321 selected-customer UI | Operator/support role | Future operator aggregate only. Selected-customer list/create UI now exists from account routes; aggregate queue, notes, and status changes remain separate. |
