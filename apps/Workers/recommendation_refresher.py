...
async def run_once(
    ...
    referrers = await _active_referrers()

    for ref_hash in referrers:
    ...
    campaigns = await _active_campaigns()
    ...
    for (
        ...
        await upsert_campaign_insights_cache(
            entry,
            ttl_seconds=86400,
        )